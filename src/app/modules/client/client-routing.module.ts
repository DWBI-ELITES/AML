...
import { CddComponent } from './cdd/cdd/cdd.component';
import { CtrComponent } from './ctr/ctr/ctr.component';
...
const routes: Routes = [
  ...
  {
    path: 'cdd',
    component: CddComponent,
    data: { title: ':: Fintrak AML :: CDD' }
  },
  {
    path: 'ctr',
    component: CtrComponent,
    data: { title: ':: Fintrak AML :: CTR' }
  },
  {
    path: 'chat',
